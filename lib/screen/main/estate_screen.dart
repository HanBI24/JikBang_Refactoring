                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            children: <Widget>[
                              Image.asset('images/apt.PNG',width: 60,height: 130,fit: BoxFit.scaleDown),
                            ],
                          ),
                        ],
                      ),
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            children: <Widget>[
                              Image.asset('images/tworoom.PNG',width: 60,height: 130,fit: BoxFit.scaleDown),
                            ],
                          ),
                        ],
                      ),
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            children: <Widget>[
                              Image.asset('images/oneroom.PNG',width: 90,height: 130,fit: BoxFit.scaleDown),
                            ],
                          ),
                        ],
                      ),
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            children: <Widget>[
                              Image.asset('images/op.PNG',width: 40,height: 130,fit: BoxFit.scaleDown),
                            ],
                          ),
                        ],
                      ),
