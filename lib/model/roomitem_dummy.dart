...
class RoomListAdd {
  ...
  roomAdd7() {
    RoomItem roomItem = RoomItem(
        position: 7,
        imgPath: 'images/room_7.jpg',
        recommend: '추천 : 원룸, 분리형/원룸',
        roomPrice: '월세 400/25',
        arch: '11평, 2층',
        location: '춘천시 후평동',
        comment: '강대병원 10분거리. 두 명 사용 가능');
